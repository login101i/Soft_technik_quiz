...
const qBank = [
  ...
  },
  {
    ...
    answers: [
      "Piszemy do Pytla aby założył dane do bazy danych i SQL",
      "Trzeba zrobić koniecznie kawę",
    ],
  ...
  },
  {
    ...
    answers: [
      "Trzeba założyć url, skrypty, logo Klienta",
      "Trzeba tylko założyć url",
    ],
  ...
  },
  {
    ...
    answers: [
      "To powie Ci Sławek",
      "Trzeba tylko założyć skrypty i nie pytaj się.. ",
    ],
  ...
  },
  {
    ...
    answers: [
      "Kiedy będziemy musieli powrzucać obrazki",
      "Kiedy chcemy wejść na 9gag.com",
    ],
  ...
  },
  {
    ...
    answers: [
      "Kto będzie prowadził projekt ze strony Klienta",
  ...
  },
  {
    ...
    answers: [
      "Tworzenie bazy pod Klienta, edutujac baze wejsciową",
      "Tworzenie bazy pod Klienta bazując od zera",
    ],
  ...
  {
    question:
      "Czy ustawienie nowej bazy dla Klienta to to samo co ustawienie bazy materiałowej?",
  ...
  },
  {
    ...
    answers: [
      "Powinno to być ustalone z Adamem przez Klienta i potwierdzone przeze mnie",
      "To inaczej nazwa zorzy polarnej",
    ],
    correct:
      "Powinno to być ustalone z Adamem przez Klienta i potwierdzone przeze mnie",
    questionId: Math.random(),
  },
  {
    ...
    answers: [
      "Zrobić ANALIZĘ replikacji materiałowej",
      "Zrobić backup bazy danych na, której bedzie się bazować",
    ],
  ...
  {
    question:
      "Co to jest baza danych imos u Klienta/  Czemu nie nazwać tego bazą danych po prostu??",
    answers: [
      "To dane w jego jego bazie imos",
      "Możemy nazwać to bazą danych po prostu",
    ],
...

  {
    ...
    answers: [
      "Weryfikujemy z nią ustalenia z Adamem",
  ...
  {
    question:
      "Co musimy zweryfikować przy replikacji gdy mamy już dane od Klienta?",
    answers: [
  ...
  {
    question:
      "Jak weryfikujemy czy możemy przenieść wszystkie niezbędne dane z imos Klienta do założenia zasobów w OM",
    answers: [
      "To już tylko Sławek wie",
      "Nic, nie trzeba weryfikować, jedziemy z koksem",
    ],
  ...
  },
  {
    ...
    answers: [
      "Jak będą nazywać się materiały w OM oraz muszą być wpisane wymiary płyty.",
      "Jak będą nazywać się materiały w OM.",
    ],
    correct:
      "Jak będą nazywać się materiały w OM oraz muszą być wpisane wymiary płyty.",
    questionId: Math.random(),
...

  {
    ...
    answers: [
      "Jeśli da się zrobić najpierw replikację to replikację",
      "Zawsze najpierw Baza Danych",
    ],
  ...
  {
    question:
      "Nie daj sobie wcisnąć, że to ja mam zakładać zasoby klientów? Prawda czy fałsz?",
    answers: [
      "Oczywiście, to zadanie Klienta.",
      "Nie nie, to Twoja działka",
      "Negocjuj z Klientem",
    ],
  ...
  {
    question:
      "Co należy zrobić szczegółowo z Klientem jeśli chodzi o aspekty produkcyjne?",
    answers: [
...

  {
    ...
    answers: [
      "Testowanie na rzeczywistych, wyprodukowanych korpusach",
      "Testy modeli w K3D",
      "Testy na produckji u Klienta",
    ],
  ...
  {
    question:
      "Za fronty akrylowe z Fast Cut płacimy tylko za zamówiony materiał",
    answers: ["TAK", "NIE"],
    correct: "TAK",
    questionId: Math.random(),
  },
  ...
  },
  {
    ...
    answers: [
      "TANDEMBOX posiada dużą nośność – do 65 kg, w połączeniu z relingami pozwala na zastosowanie wysokich frontów.",
    ],
    correct:
      "TANDEMBOX posiada dużą nośność – do 65 kg, w połączeniu z relingami pozwala na zastosowanie wysokich frontów.",
    questionId: Math.random(),
  ...
  },
  {
    ...
    answers: [
      "Frontów szuflad",
      "Frontów otwieranych lewo/prawo ",
      "Zarówno frontów szuflad jak i frontów lewych i prawych",
    ],
  ...
  {
    question:
      "Wysokość szuflady standardowej N oznacza minimalny zakres przestrzeni od : ",
...

  {
    ...
    answers: [
      "Blum LBX, odpowiednio 40/70kg",
      "Blum TBX, odpowiednio 40/70kg",
      "Blum TBX, odpowiednio 30/65kg",
    ],
  ...
  },
  {
    ...
    answers: [
      "Ilość milimetrów, o które zmniejszony będzie docelowy wymiar płyty na szerokość.",
      "Oklejanie płyty",
    ],
    correct:
      "Ilość milimetrów, o które zmniejszony będzie docelowy wymiar płyty na szerokość.",
  ...
  {
    question:
      " Czy wprowadzone wartości brzegowań  uwzględniają szerokości rzazu?",
    answers: [
      "Wprowadzone wartości brzegowań nie uwzględniają szerokości rzazu",
      "TAk, uwzględniają ją.",
    ],
...

  {
    ...
    answers: [
      ...
      "Combine, Repeat, Use, Delete",
      "Change, Refresh, Update, Drop",
    ],
  ...
  },
  {
    ...
    answers: [
      "Generuje zlecenia w IMOS z pliku XML np z konfiguratora kiedy klient generuje zamówienie w OM.",
    ],
    correct:
      "Generuje zlecenia w IMOS z pliku XML np z konfiguratora kiedy klient generuje zamówienie w OM.",
  },
  ...
  },
  {
    ...
    answers: [
      "Program na maszynę, na centrum Homag'a, inaczej rozszerzenie pliku",
      "System zarzadzania zamówieniami podobny do CRM",
    ],
    correct:
      "Program na maszynę, na centrum Homag'a, inaczej rozszerzenie pliku",
  },
  ...
  },
  {
    ...
    answers: [
      "SCMMM",
      "Biesse",
      "SCM bo trzecia litera to M a S jest blisko P w alfabecie",
    ],
  ...
  },
  {
    ...
    answers: [
      "To jest roszszerzenie na maszynę Felder, To Ci No Felder",
      "Do maszyny Homag, Homag oprócz NPR ma również TCN",
    ],
  ...
  },
  {
    ...
    answers: [
      "Brunatnoszary, Jedwabiście Biały, Szary",
      "Jedwabiście Biały, Brunatnoszary, Szary",
    ],
  ...
  },
  {
    ...
    answers: [
      "Prowadnicę szuflady otwieraną uchwytem",
      "Prowadnicę szuflady otwieraną Tip-onem",
    ],
  ...
  },
  {
    ...
    answers: [
      "Że jest wraz z systemem Bluemotion",
      "Że jest wraz z systemem Tip-On",
    ],
  ...
  },
  {
    ...
    answers: [
      "5 podstawowych zasobów, ustawienia maszyn, podstawowe raporty",
      "Baza podstawowa z Soft-technik",
    ],
  ...
  },
  {
    ...
    answers: [
      "Parametry piły i inne pierdy",
      "Jakie w firmie X mają miesięczne zapotrzebowanie na cukier do kawy.",
    ],
...

  {
    ...
    answers: [
      "Delikatne i ciche zamykanie frontu.",
  ...
  },
  {
    ...
    answers: [
      "Zasada jest taka, że zasoby, które są filtrami zakładamy w OM z typem materiału 10 i przypisujemy do grupy Filtry",
      "Zasada jest taka, że zasoby, które są filtrami zakładamy w OM z typem materiału 1 i przypisujemy do grupy Filtry",
    ],
    correct:
      "Zasada jest taka, że zasoby, które są filtrami zakładamy w OM z typem materiału 10 i przypisujemy do grupy Filtry",
  },
  {
    ...
    answers: [
      "Jest to identyfikator folderu, do którego przypisany jest obiekt",
      "Jest to inaczej zmienna tłumaczeniowa",
    ],
  ...
  },
  {
    ...
    answers: [
      "Zmienne z tym przedrostkiem są zmiennymi, które wykorzystywane są do integracji z imosem.",
      "To taki przydługi przedrostek bo autor tak chciał.",
    ],
    correct:
      "Zmienne z tym przedrostkiem są zmiennymi, które wykorzystywane są do integracji z imosem.",
  },
  {
    ...
    answers: [
      "W imosie pod zmienną S_B_GR_LS1 wstawiona zostanie wartość jaka wynika ze zmiennej CorpusGrainSides w K3D",
      "W imosie pod zmienną S_B_GR_LS1 wstawiona zostanie wartość jaka wynika ze zmiennej CorpusGrainSides",
    ],
    correct:
      "W imosie pod zmienną S_B_GR_LS1 wstawiona zostanie wartość jaka wynika ze zmiennej CorpusGrainSides w K3D",
  },

  {
    ...
    answers: [
      "Lista parametrów - uzupełniane są automatycznie, nie możemy ich edytować.",
      " Zmienne systemowe – uzupełniane są automatycznie – są to zmienne zaprogramowane przez Agmasoft, na nie nie mamy wpływu.",
      "Zmienne ukryte – w tym miejscu przypisujemy do danego obiektu zmienne ukryte, tzn. są to wartości na które użytkownik nie ma wpływu.",
    ],
    correct:
      "Lista parametrów - uzupełniane są automatycznie, nie możemy ich edytować.",
  },
  ...
  {
    question:
      "Maszyna Schelling ma maksymalną liczbę znaków na etykiecie w liczbie:",
    answers: ["20", "40", "30", "50"],
    correct: "20",
  },
  {
    question:
      "Status odebrane w FC2, pojawia się on po zaznaczeniu ...... wydano w OM.",
    answers: ["ptaszka", "statusu gotowe do obioru", "wydano"],
    correct: "ptaszka",
  },
  {
    question:
      "Aby automatycznie zaznaczać zlecenie jako wydane musimy zaznaczyć opcję:",
    answers: [
      "Powiąż z flagą wydania w gnieździe maszyny o karcie opcje",
      "Na razie nie ma takiej opcji",
      "Powiąż z flagą wydania w gnieździe maszyny o karcie przypisane operacje",
    ],
    correct: "Powiąż z flagą wydania w gnieździe maszyny o karcie opcje",
  },
  {
    question:
      "Jaka jest różnica w Order Manager pomiędzy rozkrojem a opymalizacją?",
    answers: [
      "To jest jedno i to samo",
      "To spora różnica?",
      "Tego nie wie nikt",
    ],
    correct: "To spora różnica?",
  },
  {
    question:
      "Co należy zrobić aby zoptymalizować ponownie zamówienie gdy znienimy wymiary użytkownika z netto na brutto?",
    answers: [
